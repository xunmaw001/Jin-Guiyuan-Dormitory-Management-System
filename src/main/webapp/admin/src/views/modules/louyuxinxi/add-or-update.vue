<template>
	<div class="addEdit-block" :style='{"padding":"10px 30px"}' style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","justifyContent":"flex-start"}' class="input" v-if="type!='info'"  label="楼宇名称" prop="louyumingcheng">
					<el-input v-model="ruleForm.louyumingcheng" placeholder="楼宇名称" clearable  :readonly="ro.louyumingcheng"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","justifyContent":"flex-start"}' v-else class="input" label="楼宇名称" prop="louyumingcheng">
					<el-input v-model="ruleForm.louyumingcheng" placeholder="楼宇名称" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","justifyContent":"flex-start"}' class="input" v-if="type!='info'"  label="楼宇位置" prop="louyuweizhi">
					<el-input v-model="ruleForm.louyuweizhi" placeholder="楼宇位置" clearable  :readonly="ro.louyuweizhi"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","justifyContent":"flex-start"}' v-else class="input" label="楼宇位置" prop="louyuweizhi">
					<el-input v-model="ruleForm.louyuweizhi" placeholder="楼宇位置" readonly></el-input>
				</el-form-item>
			</template>
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='louyuweizhi'){
							this.ruleForm.louyuweizhi = obj[o];
							this.ro.louyuweizhi = true;
							continue;
						}
				}
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `louyuxinxi/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.louyuxinxiCrossAddOrUpdateFlag = false;
						 this.parent.search();
