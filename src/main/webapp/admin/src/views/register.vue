	...
	<div>
		<div class="container" :style='{"minHeight":"100vh","alignItems":"center","background":"url(http://codegen.caihongy.cn/20221201/ad8b598515704341aed4de6f4d3b36b8.jpg)","display":"flex","width":"100%","backgroundSize":"100% 100%","backgroundPosition":"center center","backgroundRepeat":"no-repeat","justifyContent":"center"}'>
			<el-form v-if="pageFlag=='register'" :style='{"minHeight":"750px","padding":"30px 0px 60px 600px","margin":"0px auto 0 auto","borderRadius":"0px","background":"url(http://codegen.caihongy.cn/20221130/96464fa9ee1447fcac8ed4cef9e06ae1.png) no-repeat right top","width":"1200px","backgroundSize":"auto 100%","height":"auto"}' ref="rgsForm" class="rgs-form" :model="rgsForm">
				<div v-if="true" :style='{"width":"550px","margin":"0 0px 16px -34px","lineHeight":"40px","fontSize":"20px","color":"#160f53","textAlign":"center"}' class="title">金桂圆寝室管理系统的设计与开发注册</div>
				<el-form-item :style='{"width":"80%","padding":"0","margin":"0 auto 10px","flexWrap":"wrap","display":"block","height":"auto"}' class="list-item" v-if="tableName=='xuesheng'">
					<div v-if="false" :style='{"width":"100%","lineHeight":"44px","fontSize":"14px","color":"rgba(64, 158, 255, 1)"}' class="lable">学号</div>
				...
				<el-form-item :style='{"width":"80%","padding":"0","margin":"0 auto 10px","flexWrap":"wrap","display":"block","height":"auto"}' class="list-item" v-if="tableName=='xuesheng'">
					<div v-if="false" :style='{"width":"100%","lineHeight":"44px","fontSize":"14px","color":"rgba(64, 158, 255, 1)"}' class="lable">年龄</div>
					<el-input  v-model="ruleForm.nianling"  autocomplete="off" placeholder="年龄"  type="text"  />
				</el-form-item>
				<el-form-item :style='{"width":"80%","padding":"0","margin":"0 auto 10px","flexWrap":"wrap","display":"block","height":"auto"}' class="list-item" v-if="tableName=='xuesheng'">
					<div v-if="false" :style='{"width":"100%","lineHeight":"44px","fontSize":"14px","color":"rgba(64, 158, 255, 1)"}' class="lable">班级</div>
				...
				<el-form-item :style='{"width":"80%","padding":"0","margin":"0 auto 10px","flexWrap":"wrap","display":"block","height":"auto"}' class="list-item" v-if="tableName=='suguan'">
					<div v-if="false" :style='{"width":"100%","lineHeight":"44px","fontSize":"14px","color":"rgba(64, 158, 255, 1)"}' class="lable">宿管账号</div>
				...
				<el-form-item :style='{"width":"80%","padding":"0","margin":"0 auto 10px","flexWrap":"wrap","display":"block","height":"auto"}' class="list-item" v-if="tableName=='suguan'">
					<div v-if="false" :style='{"width":"100%","lineHeight":"44px","fontSize":"14px","color":"rgba(64, 158, 255, 1)"}' class="lable">宿管姓名</div>
		...
		login() {
            ...
            if(this.ruleForm.touxiang!=null) {
                this.ruleForm.touxiang = this.ruleForm.touxiang.replace(new RegExp(this.$base.url,"g"),"");
					...
					if(`suguan` == this.tableName && this.ruleForm.dianhua&&(!this.$validate.isMobile(this.ruleForm.dianhua))){
						this.$message.error(`电话应输入手机格式`);
						return
					}
